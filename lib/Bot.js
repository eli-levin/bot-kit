...
// Config
//
const defaultConfidence = require('./constants/Constants.js').defaultConfidence;
...
//
Bot.prototype.trainBot = function(trainingData, testData, confidence) {
    let results = [];
    ...
    this.isTrained = score > (confidence ? confidence : defaultConfidence);
